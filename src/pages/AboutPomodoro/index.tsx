            ...
            <Container>
                <GenericHtml>
                    ...
                    <p>
                        ...
                        <strong>Francesco Cirillo</strong>, que consiste em dividir o trabalho em blocos de tempo (os
                        famosos "Pomodoros") intercalados com pausas. O objetivo é manter o foco total por um período
                        curto e garantir descansos para evitar o cansaço mental.
                    </p>
                    ...
                    <p>
                        ...
                        acessar a <a href='/settings'>página de configurações</a> e ajustar os minutos como preferir.
                    </p>
                    ...
                    <p>
                        Assim, você sempre sabe em que parte do processo está e o que vem a seguir. Não precisa mais
                        anotar no papel ou ficar calculando de cabeça!
                    </p>

                    <h3>📊 Histórico automático</h3>
                    <p>
                        Todas as suas tarefas e ciclos concluídos ficam salvos no <a href='/history'>histórico</a>, com
                        status de completas ou interrompidas. Assim, você consegue acompanhar sua evolução ao longo do
                        tempo.
                    </p>
                    ...
                    <p>
                        <strong>Pronto pra focar?</strong> Bora lá <a href='/'>voltar para a página inicial</a> e
